...
async function main() {
	...
	await hre.run("verify:verify", {
		...
		constructorArguments: [
			...
			"Mint_TEA_80001_1706", // Name of the main table in the format {prefix}_{chainId}_{tableId}
			"Mint_TEA_80001_1707", // Name of the attributes table in the format {prefix}_{chainId}_{tableId}
		],
	})
}
